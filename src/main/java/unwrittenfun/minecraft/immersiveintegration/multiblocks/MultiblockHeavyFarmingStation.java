...
public class MultiblockHeavyFarmingStation implements IMultiblock {
      ...
      for (int l = 0; l < 5; l++) {
        for (int w = 0; w < 5; w++) {
          if ((h == 1 && (w == 2 && (l == 0 || l == 4))) || (h == 1 && (l == 2 && (w == 0 || w == 4)))) {
            ...
            blockStructure[h][l][w] = new ItemStack(IEContent.blockWoodenDecoration, 1, 1);
          } else if (((h == 0 && ((w == 0 || w == 4) && (l == 1 || l == 3))) || (h == 0 && ((l == 0 || l == 4) && (w == 1 || w == 3)))) || ((h == 1 && ((w == 0 || w == 4) && (l == 1 || l == 3))) || (h == 1 && ((l == 0 || l == 4) && (w == 1 || w == 3)))) || ((h == 2 && ((w == 0 || w == 4) && (l == 1 || l == 3))) || (h == 2 && ((l == 0 || l == 4) && (w == 1 || w == 3)))) || (h == 3 && (w == 1 && (l == 1 || l == 3))) || (h == 3 && (w == 3 && (l == 1 || l == 3)))) {
    ...
    for (int dz = -4; dz <= 0; dz++) {
      for (int dx = -2; dx <= 2; dx++) {
        for (int dy = -1; dy <= 2; dy++) {
          ...
          System.out.println("dy=" + dy + ", dx=" + dx + ", dz=" + dz);
          ItemStack targetItem = blockStructure
              [dy + 1]
              [dz + 4]
              [dx + 2];
          if (targetItem != null && (world.getBlock(x + ddx, y + dy, z + ddz) != ((ItemBlock) targetItem.getItem()).field_150939_a || world.getBlockMetadata(x + ddx, y + dy, z + ddz) != targetItem.getItemDamage())) {
    ...
    for (int dz = -4; dz <= 0; dz++) {
      for (int dx = -2; dx <= 2; dx++) {
        for (int dy = -1; dy <= 2; dy++) {
          ...
          ItemStack targetItem = targetStructure[dy + 1][dz + 4][dx + 2][axis];
          ...
          if (tileEntity instanceof IMultiblockTile) {
            ...
            if (blockStructure[dy + 1][dz + 4][dx + 2] == null) {
              multiblock.setReplaced(null);
            } else {
              multiblock.setReplaced(blockStructure[dy + 1][dz + 4][dx + 2].copy());
            }
  ...
  public ItemStack[] getTotalMaterials() {
    return new ItemStack[]
        ...
        new ItemStack(IEContent.blockWoodenDecoration, 20, 1),
